...
/* package pweb-link-shortener-0.1.0.0 */
#ifndef VERSION_pweb_link_shortener
#define VERSION_pweb_link_shortener "0.1.0.0"
#endif /* VERSION_pweb_link_shortener */
#ifndef MIN_VERSION_pweb_link_shortener
#define MIN_VERSION_pweb_link_shortener(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pweb_link_shortener */
...
#define CURRENT_COMPONENT_ID "pweb-link-shortener-0.1.0.0-inplace-pweb-link-shortener"
